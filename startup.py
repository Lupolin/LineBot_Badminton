...
from infrastructure import registry as infra
...
class AppStartup:
    def __init__(self, except_handlers=None):
        self.logger = infra.setup_logger
        ...
        infra.setup_opentelemetry()
        infra.setup_opentelemetry_instrumentor(self._app, excluded_urls=[])
